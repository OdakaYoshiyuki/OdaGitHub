========================================================================
    Win32 アプリケーション: LogTool プロジェクトの概要
========================================================================

この LogTool アプリケーションは、AppWizard により作成されました。
...
LogTool.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル LogTool.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル LogTool.rc 
    にインクルードされます。
